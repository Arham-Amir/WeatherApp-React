...
export default function Navbar(props) {
  return (
    <section className={`${props.class} 2xl:text-2xl sm:w-full flex sm:flex-row justify-center lg:py-5 xl:px-2 lg:px-0`} >
      <section className="lg:bg-gray-700  sm:bg-sky-600 lg:w-4/5 sm:w-full rounded-[20px] flex lg:flex-col sm:flex-row items-center py-6 gap-5" >
